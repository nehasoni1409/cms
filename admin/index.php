...
<?php include "includes/admin_header.php"; ?>
    ...
    <div class="row">
            ...
            <div class="col-lg-3 col-md-6">
                ...
                $post_published_counts=mysqli_num_rows($select_all_publish_post);

                $query="SELECT * FROM comments WHERE comment_status='unapproved'";
                $select_all_unapproved=mysqli_query($connection,$query);
                $unapproved_counts=mysqli_num_rows($select_all_unapproved);
                ...
                <div class="row">
                    ...
                    function drawChart() {
                        ...
                        <?php
                           $element_text = ['All Posts', 'Draft Posts', 'Published Posts', 'Categories', 'Users', 'subscriber', 'Comments', 'unapproved'];
                           $element_count = [$post_counts, $post_draft_counts, $post_published_counts, $category_counts, $user_counts, $subscriber_counts, $comment_counts, $unapproved_counts];
